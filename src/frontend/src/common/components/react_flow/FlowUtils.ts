...
export const agentColors: Record<string, string> = {
  ...
  'order-mgmt-agent': '#A52A2A', // Brown (hex form of "brown" so alpha-hex badge styling works)
  'product-rec-agent': '#2196F3', // Blue
  'personalization-agent': '#E91E63', // Pink
  'ts-agent': '#FF9800', // Orange
  'guardrail-node': '#0d9488', // Teal — policy/guardrail
  'evaluation-node': '#7c3aed', // Violet — evaluation
  'customer': '#607d8b', // Blue-Gray
  'response': '#009688', // Teal
  'action-group': '#A52A2A', // Brown
