...
export class Auth extends Construct {
    ...
    constructor(scope: Construct, id: string, props: AuthProps) {
        ...
        const userPool = new LabsUserPool(this, "userPool", {
            // Self-service sign-up is enabled: visitors register from the login page,
            // Cognito emails a verification code, and confirming it fires the
            // postConfirmation trigger below to seed that user's demo data. Because
            // the app then invokes Bedrock on their behalf (a cost), keep this behind
            // the WAF WebACL and disable it for any deployment you don't want the
            // public to self-register into.
            ...
            // Plus feature plan enables advanced security (threat protection),
            // satisfying AwsSolutions-COG8 without a suppression.
        ...
        NagSuppressions.addResourceSuppressions(userPool, [
            {
                ...
                reason: "MFA is not enforced for this demo deployment; enable it before any production use.",
            },
            {
